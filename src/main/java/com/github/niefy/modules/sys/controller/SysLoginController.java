...
public class SysLoginController extends AbstractController {
    ...
    @ApiOperation(value = "登录",notes = "不需获取验证码")
    public Map<String, Object> token(@RequestBody SysLoginForm form) {
        //用户信息
        SysUserEntity user = sysUserService.queryByUserName(form.getUsername());
        ...
        //生成token
        return Result.ok().put("token", sysUserTokenService.getById(user.getUserId()).getToken());
    }
