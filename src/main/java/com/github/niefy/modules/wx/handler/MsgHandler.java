...
public class MsgHandler extends AbstractHandler {
    ...
    public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage,
        ...
        boolean autoReplyedFail = !msgReplyService.tryAutoReply(appid, false, fromUser, textContent);
        if (autoReplyedFail) {
        ...
        if (TRANSFER_CUSTOMER_SERVICE_KEY.equals(textContent) || autoReplyedFail) {
